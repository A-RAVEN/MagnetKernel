...
void MGPipelineManager::cmdExecute(VkCommandBuffer commandBuffer, int frameBufferID)
{
	...
	vkCmdPushConstants(commandBuffer, pipelineLayout, VK_SHADER_STAGE_VERTEX_BIT, OwningRenderer->UNIFORM_BIND_POINT_LIGHT, sizeof(mgm::vec3), &light);
	...
	vkCmdPushConstants(commandBuffer, pipelineLayout, VK_SHADER_STAGE_VERTEX_BIT, OwningRenderer->UNIFORM_BIND_POINT_CAMERA, sizeof(UniformBufferObject), &ubo);
	...
	instance0->cmdDraw(commandBuffer, pipelineLayout, OwningRenderer->UNIFORM_BIND_POINT_MODEL_MATRIX);
	instance1->cmdDraw(commandBuffer, pipelineLayout, OwningRenderer->UNIFORM_BIND_POINT_MODEL_MATRIX);
